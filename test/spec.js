...
img1.setAttribute("data-bttrlazyloading-triggermanually", testFixture.triggerManually);
img1.setAttribute("data-bttrlazyloading-updatemanually", testFixture.updateManually);
...
img5.setAttribute("data-bttrlazyloading-xs", '{"src": "' + testFixture.xs.src + '", "width" : ' + testFixture.xs.width + ',  "height" : ' + testFixture.xs.height + '}');
img5.setAttribute("data-bttrlazyloading-sm", '{"src": "' + testFixture.sm.src + '", "width" : ' + testFixture.sm.width + ',  "height" : ' + testFixture.sm.height + '}');
img5.setAttribute("data-bttrlazyloading-md", '{"src": "' + testFixture.md.src + '", "width" : ' + testFixture.md.width + ',  "height" : ' + testFixture.md.height + '}');
img5.setAttribute("data-bttrlazyloading-lg", '{"src": "' + testFixture.lg.src + '", "width" : ' + testFixture.lg.width + ',  "height" : ' + testFixture.lg.height + '}');
