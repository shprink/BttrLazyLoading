...
var bugFix24 = document.createElement("img");
bugFix24.setAttribute("id", "bugFix24");
bugFix24.setAttribute("data-bttrlazyloading-sm-src", '');
bugFix24.setAttribute("data-bttrlazyloading-md-src", testFixture.md.src);
bugFix24.setAttribute("data-another-data-attribute", 'shouldExist');
bugFix24.setAttribute("data-another-data-attribute2", 'shouldExist2');
bugFix24.setAttribute("data-bttrlazyloading-lg-src", testFixture.lg.src);
window.document.body.appendChild(bugFix24);

describe("Bug fixes", function() {

    beforeEach(function(done) {
        $("#bugFix24").bttrlazyloading();
        $("#bugFix24").trigger('bttrlazyloading.load');
    ...
    afterEach(function() {
        $("#bugFix24").bttrlazyloading('destroy');
        $("#bugFix24").attr('src', '');
    });

    it("Fix #24", function(done) {
        var instance = $("#bugFix24").data('bttrlazyloading');
        expect($("#bugFix24").data('bttrlazyloading-sm-src')).toEqual('');


        expect($("#bugFix24").data('bttrlazyloading-lg-src')).toEqual(testFixture.lg.src);
        expect(instance.options.lg.src).toEqual(testFixture.lg.src);

        expect($("#bugFix24").data('another-data-attribute')).toEqual('shouldExist');
        expect($("#bugFix24").data('another-data-attribute2')).toEqual('shouldExist2');

        expect(instance.options.md.src).toEqual(testFixture.md.src);
        expect($("#bugFix24").data('bttrlazyloading-md-src')).toEqual(testFixture.md.src);
        done();
    });
});